...
npm run dev -- --input sample/input.json --output report.md --asset AUSD --scrape-agora

# From compiled JS
npm run build
npm run generate -- --input sample/input.json --output report.md --asset AUSD --scrape-agora
```
